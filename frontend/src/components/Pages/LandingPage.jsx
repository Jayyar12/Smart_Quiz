...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen text-[#000000] bg-[#F1EDE5] relative overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 bg-[#FFFFFF]/80 backdrop-blur-sm shadow-sm border-b border-[#E46036]/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <span className="text-2xl font-bold tracking-wide text-[#000000]">SmartQuiz</span>
          </button>
        ...
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 right-0 bg-[#FFFFFF] shadow-lg border-t border-[#E46036]/10"
          >
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20 pt-28">
        <div className="relative max-w-6xl w-full">
          <motion.div
            ...
            className="flex flex-col md:flex-row items-center bg-[#FFFFFF] rounded-3xl shadow-2xl p-8 md:p-12 gap-8"
          >
            <div className="flex-1 text-left">
              ...
              <p className="text-lg text-[#000000] mb-6 max-w-xl">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="px-6 py-3 text-lg font-semibold rounded-xl bg-[#E46036] hover:bg-[#000000] text-[#FFFFFF] transition shadow"
                >
                  Start Now
                </button>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {featuresData.map((feature, idx) => (
              <motion.article
                key={idx}
                className="flex flex-col items-start gap-4 bg-[#FFFFFF] rounded-2xl p-6 shadow hover:shadow-lg transition"
                whileHover={{ y: -6 }}
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-lg bg-[#FFF4F0] text-[#E46036]">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold text-[#000000]">{feature.title}</h3>
                <p className="text-[#000000] leading-relaxed">{feature.desc}</p>
              </motion.article>
            ))}
          </motion.div>
        </div>
      ...
      {/* News Section */}
      <section id="News" className="py-16 px-6 bg-[#F9F7F6]">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">Latest <span className="text-[#E46036]">News</span></h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <article className="bg-[#FFFFFF] rounded-2xl p-6 shadow hover:shadow-lg transition text-left">
              <h3 className="text-xl font-semibold mb-2 text-[#000000]">Auto-Grading Feature Released</h3>
              <p className="text-[#000000] mb-3">Automatic grading for objective questions is now available — save time and get instant results.</p>
              <time className="text-[#E46036] font-medium text-sm">Sep 10, 2025</time>
            </article>

            <article className="bg-[#FFFFFF] rounded-2xl p-6 shadow hover:shadow-lg transition text-left">
              <h3 className="text-xl font-semibold mb-2 text-[#000000]">Leaderboards & Live Results</h3>
              <p className="text-[#000000] mb-3">Users can now see real-time rankings while games are live — encourage friendly competition.</p>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-[#FFF7F4] border border-[#E46036]/10 mb-6">
            <span className="text-[#000000] font-medium">Trusted by hosts and users worldwide</span>
          </div>

          <h3 className="text-2xl font-bold mb-3 text-[#000000]">Empowering Engagement Through Play</h3>
          <p className="text-[#000000] leading-relaxed">Run fast-paced quizzes, collect insightful results, and create memorable learning experiences for everyone.</p>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-[#FFFFFF] border-t border-[#E46036]/10 mt-12">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col items-center space-y-6">
          <div className="flex items-center space-x-3">
            ...
            <span className="font-bold text-lg text-[#000000]">SmartQuiz</span>
          </div>

          <div className="flex justify-center space-x-6 text-2xl text-[#000000]">
